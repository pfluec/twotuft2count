...
def segment_images(input_path, output_path, model_dir=None, method="instanseg"):
    """
    Segments input images using either InstanSeg or another user-specified method.
    - method: 'instanseg' or 'cellpose'
    - model_dir: directory where the user's model is stored
    """
